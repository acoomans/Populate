...
@interface ACMaleFaceImageSet ()
- (NSArray*)files;
@end

@implementation ACMaleFaceImageSet
...
- (NSArray*)files {
    ...
    dispatch_once(&onceToken, ^{
        ...
        NSString *directory = [[bundle pathForResource:@"PopulateKit" ofType:@"bundle"] stringByAppendingPathComponent:@"male"];
