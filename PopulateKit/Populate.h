...
/** Populate let you easily add fake (randomly-generated) contacts to the iOS address book.
 *
 * Populate uses ACPerson, an Objective-C wrapper for the ABPerson records from the AddressBook Kit. An array of ACPerson can be passed to the Populate populateGroupWithName:withPersons:completion: method to be added to the address book.
 *
 ...
 *
 * ** Be careful not to erase any real contact if you use Populate on a real device! **
 */
